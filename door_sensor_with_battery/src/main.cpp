...
#define devicePrefix (char*)"S0301"
...
void setup(){
	...
	//uncomment for tests
    //resetALL();
    set_platform_credentials("mqtt.demo.konkerlabs.net", "1883", "<DEVICE_USER>", "<DEVICE_PASSWORD>", "data");
    setWifiCredentialsNotEncripted("<CLIENT_WIFI1>","<CLIENT_WIFI_PASSWORD1>");
    ...
    //since is on, send true because the dor has been open
    sendDoorState(true);
}
